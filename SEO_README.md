...
### 1. Replace the placeholder URL `returnflow.app`
Search & replace `returnflow.app` everywhere in `index.html`, `robots.txt`,
`sitemap.xml` with **your real domain**.

```powershell
# Example (PowerShell):
(Get-Content index.html) -replace 'returnflow.app', 'your-real-domain.com' | Set-Content index.html
(Get-Content robots.txt) -replace 'returnflow.app', 'your-real-domain.com' | Set-Content robots.txt
(Get-Content sitemap.xml) -replace 'returnflow.app', 'your-real-domain.com' | Set-Content sitemap.xml
```
